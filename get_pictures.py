...
if __name__ == '__main__':
    ...
    download_path = os.getenv("IMMICH_DOWNLOAD_PATH")
    ...
    cmd = [
        ...
        "archive",
        "from-immich",
        f"--from-server={immich_server}",
        f"--from-api-key={api_key}",
        "--from-album=Ingested",
        f"--write-to-folder={download_path}",
    ]
    print("Downloading pictures to IMMICH")
    try:
